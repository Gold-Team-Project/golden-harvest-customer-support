package com.teamgold.goldenharvestcustomsupport.common.config;
...
public class KafkaLocalConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        String typeMapping =
                "InquiryRequestAcceptedEvent:com.teamgold.goldenharvestcustomsupport.customersupport.command.application.event.dto.InquiryRequestAcceptedEvent";
